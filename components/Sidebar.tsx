...
function CalendarCheckIcon() {
  return (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
        d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2zm3.5-6.5l1.5 1.5 3-3" />
    </svg>
  )
}
    ...
    <aside className="fixed left-0 top-0 h-screen w-60 bg-primary flex flex-col z-40 shadow-lg">
      ...
      <div className="flex items-center gap-3 px-5 py-6 border-b border-white/10">
        <div className="w-10 h-10 rounded-full bg-accent flex items-center justify-center flex-shrink-0">
          <span className="text-primary font-bold text-sm">DL</span>
        </div>
        <div>
          <p className="text-white font-bold text-sm leading-tight">Darklight</p>
          <p className="text-white/60 text-xs leading-tight">Chess Academy</p>
        </div>
      </div>
